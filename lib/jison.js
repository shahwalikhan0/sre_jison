...
var processGrammar = require('./grammar/GrammarProcessor').processGrammar;
var augmentGrammar = require('./grammar/GrammarProcessor').augmentGrammar;
var Production = require('./grammar/Production');
var Nonterminal = require('./grammar/Nonterminal');
const lookaheadMixin = require('./parser/lookahead');
const { 
    defineItem,
    buildTable,
    findDefaults,
    lrGeneratorDebug,
    lalrGeneratorDebug,
 } = require('./codegen/LRGeneratorMixin');
 const { parserDocumentation } = require('./constants/parserDocumentation');
...
generator.processGrammar = processGrammar;
generator.augmentGrammar = augmentGrammar;
...
lrGeneratorMixin.buildTable = buildTable;

defineItem(typal, lrGeneratorMixin); //Item setting
